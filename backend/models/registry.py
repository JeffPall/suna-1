...
DEFAULT_FREE_MODEL = "DeepSeek r1"
DEFAULT_PREMIUM_MODEL = "DeepSeek r1"
...
class ModelRegistry:
    ...
    def _initialize_models(self):
        self.register(Model(
            ...
            aliases=["deepseek-r1-0528:free", "deepseek-r1"],
        ...
        self.register(Model(
            ...
            name="Qwen3 235B",
            provider=ModelProvider.OPENROUTER,
            aliases=["qwen3-235b-a22b-thinking-2507", "qwen3-235b"],
            context_window=128_000,
            capabilities=[
                ModelCapability.CHAT, 
                ModelCapability.FUNCTION_CALLING
